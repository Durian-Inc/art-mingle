...
class initialSchema1567049148150 {
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("tag" character varying NOT NULL, "displayName" character varying NOT NULL, "description" character varying NOT NULL, "price" numeric NOT NULL DEFAULT 0, CONSTRAINT "PK_a87195de40ca82f9251aa0abe1c" PRIMARY KEY ("tag"))`);
        await queryRunner.query(`CREATE TABLE "purchase" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "productTag" character varying, "transactionId" uuid, CONSTRAINT "PK_86cc2ebeb9e17fc9c0774b05f69" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sub" character varying NOT NULL, "firstName" character varying(50) NOT NULL, "lastName" character varying(50) NOT NULL, "email" character varying NOT NULL, "emailVerified" boolean NOT NULL, "isSuperAdmin" boolean NOT NULL DEFAULT false, "dateJoined" TIMESTAMP NOT NULL DEFAULT now(), "membershipExpiration" TIMESTAMP, "isActive" boolean NOT NULL DEFAULT true, "resumeId" character varying, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_00490995bdb8773265c96cd341" UNIQUE ("resumeId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_3641ff83ff7c23b2760b3df56d" ON "user" ("sub") `);
        ...
        await queryRunner.query(`CREATE TABLE "product_categories_product_category" ("productTag" character varying NOT NULL, "productCategoryName" character varying NOT NULL, CONSTRAINT "PK_d9c05e81d8763535be2ae3ecc6b" PRIMARY KEY ("productTag", "productCategoryName"))`);
        await queryRunner.query(`CREATE INDEX "IDX_bc0ca450eee25fcc591a5d3b25" ON "product_categories_product_category" ("productTag") `);
        ...
        await queryRunner.query(`ALTER TABLE "purchase" ADD CONSTRAINT "FK_36f6ef85c267412c40d1bb434db" FOREIGN KEY ("productTag") REFERENCES "product"("tag") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product_categories_product_category" ADD CONSTRAINT "FK_bc0ca450eee25fcc591a5d3b254" FOREIGN KEY ("productTag") REFERENCES "product"("tag") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "product_categories_product_category" DROP CONSTRAINT "FK_bc0ca450eee25fcc591a5d3b254"`);
        ...
        await queryRunner.query(`ALTER TABLE "purchase" DROP CONSTRAINT "FK_36f6ef85c267412c40d1bb434db"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_bc0ca450eee25fcc591a5d3b25"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_3641ff83ff7c23b2760b3df56d"`);
...
exports.initialSchema1567049148150 = initialSchema1567049148150;
